      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className={`text-sm font-medium ${summary.balance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
              {summary.balance >= 0 ? '+' : ''}{((summary.balance / (summary.totalIncome || 1)) * 100).toFixed(1)}%
            </span>
          </div>
          ...
          <p className="text-xs text-gray-500 mt-2">Available to save</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <p className="text-2xl font-bold text-gray-900">{summary.savingsRate}%</p>
