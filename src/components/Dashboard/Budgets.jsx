      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {budgets.length > 0 ? (
          budgets.map((budget) => {
            ...
            return (
              <div key={budget.id} className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                ...
                <div className="space-y-3">
                  ...
                  {status === 'warning' && (
                    <div className="flex items-center gap-2 p-2 bg-yellow-50 rounded-lg">
                      ...
                      <span className="text-xs text-yellow-700">Approaching limit</span>
                    </div>
                  )}
                  ...
                  {budget.notes && (
                    <p className="text-xs text-gray-500 italic">{budget.notes}</p>
                  )}
                </div>
              </div>
            );
          ...
          <div className="col-span-full bg-white rounded-lg shadow-sm p-12 border border-gray-100 text-center">
