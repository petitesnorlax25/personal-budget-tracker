...
const Transactions = () => {
  ...
  const userKey = currentUser ? `transactions_${currentUser.email}` : "transactions_guest";
  useEffect(() => {
    loadTransactions();
  }, []);
  ...
  <button
    ...
    className="w-full md:w-auto px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors flex items-center justify-center gap-2"
  >
  ...
  <div className="flex flex-col md:flex-row gap-4">
    ...
    <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
      ...
      <button
        ...
        className="w-full sm:w-auto px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg 
                   bg-white dark:bg-gray-900 
                   text-gray-900 dark:text-gray-100
  ...
  <div className="overflow-x-auto">
    <table className="w-full">
      <thead className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
        <tr>
          {['Date','Description','Category','Type','Amount','Actions'].map((header) => (
            <th
              key={header}
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[100] p-4">
    <div className="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {[
          { label: 'Amount', type: 'number', step: '0.01', key: 'amount', placeholder: '0.00' },
          { label: 'Category', type: 'select', key: 'category', options: categories[formData.type] },
          { label: 'Description', type: 'text', key: 'description', placeholder: 'Enter description' },
          { label: 'Date', type: 'date', key: 'date' },
          { label: 'Tags (optional)', type: 'text', key: 'tags', placeholder: 'Enter tags separated by commas' }
        ].map((field) => (
          <div key={field.key}>
